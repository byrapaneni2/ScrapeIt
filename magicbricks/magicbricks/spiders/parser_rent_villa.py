...
class MagicBricks(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for city in cities:
            ...
            if not os.path.exists('parsed/rent/villa/'+city):
                os.makedirs('parsed/rent/villa/'+city)

            for file in os.listdir('html/rent_html/villa/'+city):
                file_id = file
                url = 'file://%s/html/rent_html/villa/%s/%s' % (root,city,file)
    ...
    def parse(self, response):
        ...
        file = 'parsed/rent/villa/%s/%s' % (response.meta['city'],response.meta['file_id'])
