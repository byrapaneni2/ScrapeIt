...
class MagicBricks(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for city in cities:
            ...
            if not os.path.exists('parsed/rent/builderfloor-apartment/'+city):
                os.makedirs('parsed/rent/builderfloor-apartment/'+city)

            for file in os.listdir('html/rent_html/builderfloor-apartment/'+city):
                file_id = file
                url = 'file://%s/html/rent_html/builderfloor-apartment/%s/%s' % (root,city,file)
    ...
    def parse(self, response):
        ...
        property_type = "Builderfloor-Apartment"
        ...
        file = 'parsed/rent/builderfloor-apartment/%s/%s' % (response.meta['city'],response.meta['file_id'])
